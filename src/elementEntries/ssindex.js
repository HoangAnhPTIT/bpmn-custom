...
const TooltipProvider = {
  ...
  'group-form': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Embed a form created with the Camunda Forms editor. To associate a custom form, application, or URL to the user task, specify a form key. '), jsxRuntime.jsx("a", {
